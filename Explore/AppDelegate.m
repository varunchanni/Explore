...
- (void)setAppDefaults {
    ...
    UIColor *colorOrange = [UIColor colorWithRed:1.0f green:0.5f blue:0.0f alpha:1.0f];
    
    NSDictionary *dictAttributes = [NSDictionary dictionaryWithObjectsAndKeys:
                                    [UIColor whiteColor], NSForegroundColorAttributeName,
                                    [UIFont boldSystemFontOfSize:18], NSFontAttributeName, nil];
    
    [[UINavigationBar appearance] setBarTintColor:colorOrange];
